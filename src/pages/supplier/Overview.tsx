...
export default function SupplierOverview() {
  ...
  const loadOrders = async () => {
    try {
      ...
      const { data: assignments, error: assignErr } = await supabase
        ...
        .select('order_id, supplier_id, assignment_type, profiles:supplier_id (full_name, company_name)')
      ...
      // Load only assigned orders that are NEW (pending)
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-rc-navy">My Orders</h1>
